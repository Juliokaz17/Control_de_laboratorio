  ...
  <nav class="navbar navbar-custom navbar-expand-md navbar-dark fixed-top">
    ...
    <div class="container">
        <div class="text-center">
            ...
            <h1 class="display-4">Modificar un cliente</h1>
        </div>   
    </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-4">
            <div class="form-outline">
                <input type="number" name="clave-cliente" placeholder="1 al 100" class="form-control" />
                <label class="form-label">Clave de cliente</label>
            </div>
        </div>
        <div class="col-md-6 mb-4">
            <div class="form-outline">
                <input type="text" name="rfc" placeholder="Máx. 30 caracteres" maxlength="30" class="form-control"/>
    ...
    <!-- Submit button -->
    <button type="submit" class="btn btn-info btn-block mb-4">Modificar cliente</button><br>
</form>
</div>
</body>
    <?php
        ...
        $claveCliente = mysqli_real_escape_string($con, $_POST['clave-cliente']);
        ...
        if(mysqli_real_escape_string($con, $_POST['rfc'])<>NULL){
            $sql="UPDATE cliente
            SET Nombre_cliente='$completoCliente', RFC='$rfc', Domicilio_entrega='$domicilioEntrega', Factores_particulares='$factParticularesBool', Nombre_contacto='$completoContacto', Correo_contacto='$correoContacto', Telefono_contacto='$telContacto', Puesto_contacto='$puestoContacto' 
            WHERE Clv_cliente=$claveCliente;";
          }
